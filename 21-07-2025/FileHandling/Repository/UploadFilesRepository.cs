...
public class UploadFilesRepository : Repository<int, UploadedFile>
{
    public UploadFilesRepository(FileHandlingContext fileHandlingContext) : base(fileHandlingContext)
    {
